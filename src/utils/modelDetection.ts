...
const DEFAULT_MODEL_FALLBACK: string[] = [
  MODELS.GPT5_4, // Highest priority: Latest frontier agentic coding model
  MODELS.GPT5_3_CODEX, // Fallback: Frontier agentic coding model
...
export async function getDefaultModel(): Promise<string> {
  ...
  Logger.warn(`All default models unavailable, falling back to ${MODELS.GPT5_4}`);
  return MODELS.GPT5_4;
}
